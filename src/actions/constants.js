...
export const taxConstants = {
    ...
    GET_ALL_TAXES_FAILURE: 'GET_ALL_TAXES_FAILURE'
}
...
export const sellerConstants = {
    GET_ALL_SELLER_REQUEST: 'GET_ALL_SELLER_REQUEST',
    GET_ALL_SELLER_SUCCESS: 'GET_ALL_SELLER_SUCCESS',
    GET_ALL_SELLER_FAILURE: 'GET_ALL_SELLER_FAILURE'
}
